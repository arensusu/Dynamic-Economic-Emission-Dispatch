...
// ----------------------------------------------------------------------
vector<double> TranslateObjectives(Population *ppop, const CNondominatedSort::TFronts &fronts)
{
	Population &pop = *ppop;
...
// ----------------------------------------------------------------------
void FindExtremePoints(vector<size_t> *extreme_points, const Population &pop, const CNondominatedSort::TFronts &fronts)
{
...
//
// ----------------------------------------------------------------------
vector<double> FindMaxObjectives(const Population &pop)
{
	const size_t NumObj = pop[0].objs().size();
...
// ----------------------------------------------------------------------
void ConstructHyperplane(vector<double> *pintercepts, const Population &pop, const vector<size_t> &extreme_points)
{
...
// ----------------------------------------------------------------------
void NormalizeObjectives(Population *ppop, const CNondominatedSort::TFronts &fronts, const vector<double> &intercepts, const vector<double> &ideal_point)
{
	Population &pop = *ppop;
...
// ----------------------------------------------------------------------
void EnvironmentalSelection(Population *pnext, Population *pcur, vector<CReferencePoint> rps, size_t PopSize)
{
	Population &cur = *pcur, &next = *pnext;
	next.clear();
